...
define("TXT_HELP_IMPORT", "Las playlists pueden incluir sólo títulos musicales o rutas + títulos. <br>No debe haber encabezados ni caracteres especiales que marquen el principio o el final de la playlist. <br>El formato m3u es perfecto.<br>Puede usar <a href='http://www.tunemymusic.com/?keeporder=true' target='_blank'>tunemymusic</a> para importar fácilmente listas de reproducción de los principales portales de música.");
...
define("TXT_HELP_EXPORT", "Puede exportar varias playlists del mismo tipo a la vez. Cada playlist será única porque la música se mezcla al azar con cada iteración. Las playlists se pueden reproducir en este o en cualquier otro dispositivo, dependiendo de las rutas de reproducción que haya establecido en las opciones de generación.<br>Puede usar <a href='http://www.tunemymusic.com/?keeporder=true' target='_blank'>tunemymusic</a> para exportar fácilmente listas de reproducción de los principales portales de música.");
