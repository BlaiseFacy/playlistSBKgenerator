...
define("TXT_HELP_IMPORT", "Playlists can include music titles only or paths + titles. <br>There must be no header or special characters to mark the beginning or end of the playlist. <br>The m3u format is perfect.<br>You can use <a href='http://www.tunemymusic.com/?keeporder=true' target='_blank'>tunemymusic</a> to easily import playlists from major music portals.");
...
define("TXT_HELP_EXPORT", "You can export several playlists of the same type at once. Each playlist will be unique because the music is randomly mixed with each iteration. Playlists can be played on this or any other device, depending on the playback paths you have set in the generation options.<br>You can use <a href='http://www.tunemymusic.com/?keeporder=true' target='_blank'>tunemymusic</a> to easily export playlists from major music portals.");
